...
export function StudentEquipmentSidebar({ equipments }: StudentEquipmentSidebarProps) {
  const [searchQuery, setSearchQuery] = useState("");

  const validEquipments = equipments.filter((eq): eq is LabEquipment => eq !== null && eq !== undefined);
