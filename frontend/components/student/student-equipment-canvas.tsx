        ...
        <Card className="p-4 space-y-3 min-w-[250px]">
          ...
          {connectionMode === "connecting" && (
            <div className="space-y-2 border-t pt-2">
              <p className="text-xs text-muted-foreground">Wire color</p>
        ...
        <div className="relative min-h-full">
          ...
          >
            {allConnections.map((conn: any) => {
              ...
              const wireColor =
                (conn as StudentConnection).wireColor ||
                conn.wireColor ||
                "#3b82f6";
                  ...
                  {isStudentConnection && (
                    <>
                      ...
                      <text
                        ...
                        className="text-xs font-bold cursor-pointer pointer-events-auto"
                        fill={wireColor}
                        onClick={() => handleDeleteConnection(conn.id)}
                      >
                        ×
