...
const nodeTypes: NodeTypes = {
  equipment: EquipmentNode as any,
};
  ...
  const onConnect = useCallback(
    (connection: Connection) => {
      ...
      const newConnection = {
        ...
        wireColor: selectedWireColor || WIRE_COLORS[0]?.value || "#374151",
      };

      onConnectionsChange([...wireConnections, newConnection]);
    },
    [isWireMode, wireConnections, onConnectionsChange, selectedWireColor],
  );
  ...
  return (
    <div ref={reactFlowWrapper} className="h-full w-full">
      <ReactFlow
        ...
        connectionLineStyle={{
          stroke: isWireMode
            ? selectedWireColor || WIRE_COLORS[0]?.value || "#374151"
            : "#94a3b8",
          strokeWidth: 2,
        }}
        defaultEdgeOptions={{
